...
The bootstrap distribution of $\hat{\beta}_{\text{ratio}}$ is approximately unimodal with a distinct left skew and is centered around –170. Most estimates fall between –100 and –300, and the entire distribution is strictly negative. This indicates that the two predictors have effects in opposite directions. The heavy left tail suggests that for some bootstrap samples, the denominator (the precipitation coefficient) is close to zero, causing the ratio to become large and negative.

Right Panel: $$r^2$$

The bootstrap distribution of $r^2$ is highly concentrated, peaking around 0.941, with a left tail extending to roughly 0.930 and an upper cutoff near 0.950. These consistently high values demonstrate that the model explains about 93%–95% of the variation in maximum temperature, indicating a strong and robust goodness-of-fit.
...
The 95% confidence interval for $\hat{\beta}_{\text{ratio}} = \hat{\beta}_1 / \hat{\beta}_2$ falls between –279.127 and –125.993. Because this entire interval is strictly negative and does not include zero, we conclude with 95% confidence that the ratio of the coefficients is statistically significant and negative. This indicates that the two predictors consistently have effects in opposite directions (specifically, minimum temperature has a positive effect while precipitation has a negative effect).
