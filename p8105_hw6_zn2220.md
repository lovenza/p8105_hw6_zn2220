...
```
    ...
    ##    .id   term      estimate
    ##    <chr> <chr>        <dbl>
    ##  1 0001  r.squared  0.941  
    ##  2 0001  beta_prod -0.00643
    ##  3 0002  r.squared  0.941  
    ##  4 0002  beta_prod -0.00631
    ##  5 0003  r.squared  0.943  
    ##  6 0003  beta_prod -0.00751
    ##  7 0004  r.squared  0.936  
    ##  8 0004  beta_prod -0.00455
    ##  9 0005  r.squared  0.945  
    ## 10 0005  beta_prod -0.00778
    ## # ℹ 9,990 more rows
...
|:----------|-----------:|-----------:|
| beta_prod | -0.0082628 | -0.0036844 |
| r.squared |  0.9342782 |  0.9468756 |
