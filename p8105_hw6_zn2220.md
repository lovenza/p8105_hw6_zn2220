...
```
    ...
    ##  2 0001  beta_prod -0.00480
    ##  3 0002  r.squared  0.939  
    ##  4 0002  beta_prod -0.00765
    ##  5 0003  r.squared  0.944  
    ##  6 0003  beta_prod -0.00844
    ##  7 0004  r.squared  0.941  
    ##  8 0004  beta_prod -0.00524
    ##  9 0005  r.squared  0.945  
    ## 10 0005  beta_prod -0.00759
    ## # ℹ 9,990 more rows
...
|:----------|-----------:|-----------:|
| beta_prod | -0.0082141 | -0.0036806 |
| r.squared |  0.9342302 |  0.9468060 |
