...
```
    ...
    ##    .id   term      estimate
    ##    <chr> <chr>        <dbl>
    ##  1 0001  r.squared  0.945  
    ##  2 0001  beta_prod -0.00752
    ##  3 0002  r.squared  0.939  
    ##  4 0002  beta_prod -0.00539
    ##  5 0003  r.squared  0.934  
    ##  6 0003  beta_prod -0.00607
    ##  7 0004  r.squared  0.937  
    ##  8 0004  beta_prod -0.00653
    ##  9 0005  r.squared  0.937  
    ## 10 0005  beta_prod -0.00542
    ## # ℹ 9,990 more rows
...
|:----------|-----------:|-----------:|
| beta_prod | -0.0082014 | -0.0036515 |
| r.squared |  0.9340179 |  0.9465274 |
...
## Compare your model to two others & 4. Make this comparison in terms of the cross-validated prediction error
