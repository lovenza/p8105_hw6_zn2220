...
```
    ...
    ##    .id   term      estimate
    ##    <chr> <chr>        <dbl>
    ##  1 0001  r.squared  0.943  
    ##  2 0001  beta_prod -0.00594
    ##  3 0002  r.squared  0.939  
    ##  4 0002  beta_prod -0.00597
    ##  5 0003  r.squared  0.939  
    ##  6 0003  beta_prod -0.00592
    ##  7 0004  r.squared  0.945  
    ##  8 0004  beta_prod -0.00615
    ##  9 0005  r.squared  0.937  
    ## 10 0005  beta_prod -0.00403
    ## # ℹ 9,990 more rows
...
![](未命名_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
|:----------|-----------:|-----------:|
| beta_prod | -0.0082160 | -0.0037134 |
| r.squared |  0.9345399 |  0.9466362 |
